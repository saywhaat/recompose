...
(0, _ava2.default)('shouldUpdate implements shouldComponentUpdate', function (t) {
  var initialTodos = ['eat', 'drink', 'sleep'];
  var Todos = (0, _.compose)((0, _.withState)('todos', 'updateTodos', initialTodos), (0, _.shouldUpdate)(function (props, nextProps) {
    return props.todos !== nextProps.todos;
  }), _utils.countRenders)('div');
